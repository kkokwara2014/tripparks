...
<head>
  ...
  <title>Tripparks - Dashboard</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Tripparks <sup></sup></div>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; tripparks.com 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <!-- Page level plugins -->
  <script src="{{asset('bootstrap_admin/vendor/chart.js/Chart.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{asset('bootstrap_admin/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('bootstrap_admin/js/demo/chart-pie-demo.js')}}"></script>
